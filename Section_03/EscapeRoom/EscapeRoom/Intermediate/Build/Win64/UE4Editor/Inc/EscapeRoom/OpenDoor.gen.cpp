...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UOpenDoor()
	{
		...
		if (!OuterClass)
		{
...
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_CloseAngle_MetaData[] = {
				{ "Category", "OpenDoor" },
				{ "ModuleRelativePath", "OpenDoor.h" },
			};
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_CloseAngle = { UE4CodeGen_Private::EPropertyClass::Float, "CloseAngle", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000000001, 1, nullptr, STRUCT_OFFSET(UOpenDoor, CloseAngle), METADATA_PARAMS(NewProp_CloseAngle_MetaData, ARRAY_COUNT(NewProp_CloseAngle_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_CloseAngle,
	...
	IMPLEMENT_CLASS(UOpenDoor, 3682263163);
